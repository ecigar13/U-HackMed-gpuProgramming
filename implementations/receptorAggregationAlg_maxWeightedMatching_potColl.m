function [aggregationProbVec,receptor2cluster,cluster2receptor,clusterSize,...
    positionsNew,numPotColl,numColl,numPotColl_Assoc,numCollProbPairs,collProbStats,numberPossibleAssociations] =...
  ...
  %
      ...
      if (~isempty(assocNodeIndx_PWDist))
          ...
          % associating
          numberPossibleAssociations=length(closestPartnerNode_indx);
          %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
