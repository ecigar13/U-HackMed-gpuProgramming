function [cluster2receptor,receptor2cluster,clusterSize,receptPositions,...
    aggregationProbVec,sureAssocCount, numberPossibleAssociations] = receptorAggregationAlg_maxWeightedMatching_sureColl(...
...
%       Modified, 2017/11/30 Luciana de Oliveira
    ...
    if (any(nodeFlag))
        ...
        % associating
        numberPossibleAssociations=length(aggregNodeIndx_aggregDist);
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%                
